...
export function LiveStatsBar() {
  ...
  const volumeSol = (data.total_volume_lamports / 1e9).toFixed(2);
  ...
  return (
    <section className="w-full border-t border-border bg-card/50 py-6">
      <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-center gap-8 px-4">
        ...
        <div className="text-center">
          <div className="font-mono text-lg text-neon-orange">{volumeSol} SOL</div>
          <div className="font-pixel text-[10px] text-muted-foreground">POOL VOL</div>
        </div>
        {data.live_matches > 0 && (
