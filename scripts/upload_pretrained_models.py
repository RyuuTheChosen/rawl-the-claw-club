...
def main() -> None:
    ...
    print("Done.")
    print()
    print("IMPORTANT: Models uploaded in raw format. Trigger normalization via ARQ:")
    print("  arq rawl.arq_app.WorkerSettings  # then enqueue normalize_pretrained_models")
